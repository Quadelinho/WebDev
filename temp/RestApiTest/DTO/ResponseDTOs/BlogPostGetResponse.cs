...
namespace RestApiTest.DTO.ResponseDTOs
{
    public class BlogPostGetResponse //[Note] - tak, stosuje się zazwyczaj przyrostek DTO lub Request - Czy używanie takiego przyrostka (DTO) jest zgodne z konwencją oficjalną? (Na necie takie widziałem).
    {
        public long? Id { get; set; } //[Note] - musi być, żeby było wiadomo co aktualizować - Pola takie jak Id nie powinny być w DTO?

...
namespace RestApiTest.Core.Interfaces.Repositories
{
    public interface IBlogPostRepository : IBaseRepository<BlogPost>, ICommentable, IMarkable
    {
        ...
        IQueryable<BlogPost> GetPostsContaingInTitle(string textToSearch, int pageNo, int postsPerPage, out decimal totalPagesCount);
        IQueryable<BlogPost> GetBlogPostsChunkAsync(int pageNo, int postsPerPage, out decimal totalPagesCount);
    }
}
